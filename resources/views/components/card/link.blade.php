<a href="{{ $active ? $route : '#' }}"
	class="card multicolor-border w-100 p-10 h-100 {{ $active && $route !== '#' ? 'hover-elevate-up parent-hover' : 'cursor-default' }} overflow-hidden position-relative">
	...
	<i
		class="{{ $icon }} position-absolute top-50 end-0 translate-middle-y opacity-25 {{ $active ? 'parent-hover-primary' : '' }}"
