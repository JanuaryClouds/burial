...
<nav class="navbar navbar-expand-lg main-navbar justify-content-between px-4">
    <span class="d-flex align-items-baseline">
        <ul class="navbar-nav mr-3" x-show="!screenSmall">
            <li><a href="#" @click.prevent="sidebarMini = !sidebarMini" class="nav-link nav-link-lg"><i
    ...
    <ul class="navbar-nav">
        <li class="dropdown">
            <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">{{ Auth::user()->first_name }} {{ Auth::user()->last_name }}
                </div>
            </a>
