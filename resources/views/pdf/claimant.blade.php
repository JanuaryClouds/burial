...
<body>
    <table>
        <tr>
            ...
            <td class="no-border">
                ...
                <h2 class="text-center" style="font-family: serif; text-transform: uppercase;">Assistance Claimants
                    Report</h2>
    ...
    <table style="margin-top: 20px;">
        ...
        <tbody>
            @foreach ($claimantPerBarangay as $barangayName => $count)
                <tr>
                    <td>{{ $barangayName }}</td>
                    <td>{{ $count }}</td>
                </tr>
    ...
    <strong>Total: </strong> {{ count($claimantPerBarangay) }}
    <table style="margin-top: 20px;">
        <thead>
            <tr>
                <th>Relationship</th>
        ...
        <tbody>
            @foreach ($relationshipsPerClaimant as $relationshipName => $count)
                <tr>
    ...
    <strong>Total: </strong>{{ count($relationshipsPerClaimant) }}
    <table>
        <tbody>
            <tr>
