...
<body>
    ...
    <p style="text-align: justify; margin: 0px 10px 0px 10px; line-height: 1.5">
        ...
        <strong class="underline">{{ \Carbon\Carbon::parse($claimant->created_at)->format('F') }}</strong>,
        <strong class="underline">{{ \Carbon\Carbon::parse($claimant->created_at)->format('Y') }}</strong> dito sa
