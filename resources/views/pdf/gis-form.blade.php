	...
	<table style="width: 100%; padding: 0rem 1rem 0rem 1rem;">
		<tr>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Name</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Sex</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Age</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Civil Status</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Relationship</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Occupation</td>
			<td class="text-center"
				style="padding: 0.5rem 0rem 0.5rem 0rem;">Income</td>
		</tr>
				...
				<table>
					<tr>
						...
						<td class="field-input">
							{{ $recommendation?->amount_extended ?? 'N/A' }}
						</td>
					</tr>
				</table>
						...
						@foreach ($moa as $mode)
							<td style="text-decoration: underline;">
								@if (isset($recommendation))
									@if ($recommendation->mode_of_assistance_id == $mode->id)
										&nbsp;
										/
										&nbsp;
									@else
