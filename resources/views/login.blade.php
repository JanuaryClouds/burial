...
<section class="section d-flex justify-content-center align-items-center min-vh-100">
     <!-- begin::Aside -->
    <div  class="d-flex flex-root flex-lg-column flex-lg-row-fluid flex-lg-column-fluid flex-lg-grow-auto flex-lg-center w-xl-25 gap-lg-10 p-2 p-lg-0">
        <!-- begin::header -->
                            ...
                            <div class="mb-6" x-data="{ show: false }">
                                <label for="password" class="form-label">Password</label>
                                    ...
                                    <input :type="show ? 'text' : 'password'" 
                                        id="password" 
                                        name="password" style=" border-radius: 10px 0px 0px 10px"
                                        placeholder="Enter your password" class="form-control" required>
                                        <button type="button" @click="show = !show" class="btn btn-sm ms-1" style="background-color:#999999; border-radius: 0px 10px 10px 0px">
