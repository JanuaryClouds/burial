<div class="d-flex justify-content-end gap-3">
    <a href="{{ route('clients.gis-form', ['id' => $client->id]) }}" class="btn btn-sm btn-info pt-4" data-no-loader>
        Generate GIS Form
    </a>
    @if ($client->interviews->count() == 0)
        <button class="btn btn-primary btn-sm" type="button" data-bs-toggle="modal" data-bs-target="#set-schedule-modal">
