		...
		@can('view-users')
			<div class="menu-item">
				<a href="{{ route('user.index') }}"
					@class(['active' => Route::is('user.*'), 'menu-link'])>
		...
		@can('view-roles')
			<div class="menu-item">
				<a href="{{ route('role.index') }}"
					@class(['active' => Route::is('role.*'), 'menu-link'])>
					<span class="menu-bullet">
						<span class="bullet bullet-dot"></span>
					</span>
		...
		@can('edit-system-settings')
			<div class="menu-item">
				<a href="{{ route('system.index') }}"
					@class(['active' => Route::is('system.*'), 'menu-link'])>
					<span class="menu-bullet">
						<span class="bullet bullet-dot"></span>
					</span>
		...
		@can('view-logs')
			<div class="menu-item">
				<a href="{{ route('activity.logs') }}"
					@class(['active' => Route::is('activity.logs'), 'menu-link'])>
					<span class="menu-bullet">
						<span class="bullet bullet-dot"></span>
					</span>
