...
<div class="row justify-content-start align-items-center">
    ...
    <div class="col-12 col-md-4 col-lg-2">
        <x-form-input name="middle_name" id="middle_name" label="Middle Name" value="{{ $claimant->middle_name ?? '' }}"
...
<div class="row justify-content-start align-items-center">
    <div class="col-12 col-lg-3">
        <x-form-input name="date_of_birth" id="date_of_birth" label="Date of Birth" required="true"
