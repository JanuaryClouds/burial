                                    ...
                                    <tbody>
                                        @foreach ($applications as $application)
                                            <tr class="bg-white">
                                                ...
                                                <div id="assignment-modal-{{ $application->id }}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="assignment-modal-{{ $application->id }}" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="assignment-modal-{{ $application->id }}">Title</h5>
