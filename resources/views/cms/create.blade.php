<div x-show="showModal"
	...
	<div x-show="showModal"
		...
		<form action="{{ route(Auth::user()->getRoleNames()->first() . '.' . $resource . '.store') }}"
			method="POST">
			@csrf
			<div class="mb-4">
				<label for="name"
					class="block text-gray-700">{{ $pageTitle }}:</label>
				<input type="text"
					id="name"
					name="name"
			...
			<div class="mb-4">
				<label for="email"
					class="block text-gray-700">Remarks:</label>
				<input type="text"
					id="remarks"
					name="remarks"
			...
			@if ($resource === 'barangay')
				<div class="mb-4">
					<label for="district_id"
						class="block text-gray-700">District:</label>
					<div class="relative">
